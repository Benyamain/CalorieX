...
class AccountSignInActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        auth = Firebase.auth
        signUpBtn = findViewById(R.id.sign_up_google_button)
        alreadyHaveAccountTextView = findViewById(R.id.already_have_account_textview)
        nativeSignUpBtn = findViewById(R.id.signup_button)
        ...
        nativeSignUpBtn.setOnClickListener {
            val emailAddress = findViewById<EditText>(R.id.email_edittext).text
