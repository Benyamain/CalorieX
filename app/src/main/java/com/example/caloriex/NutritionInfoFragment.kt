...
class NutritionInfoFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        if ((bundle != null) && (bundle.containsKey("name"))) {
            ...
            detailedProteinsValue.text = arguments?.getString("protein")?.toString()?.let { if(it == "null") "0" else it } + weightUnits
            detailedKcalValue.text = arguments?.getString("calorie")?.toString()?.let { if(it == "null") "0" else it } + calorieUnits
            detailedCarbsValue.text = arguments?.getString("carbs")?.toString()?.let { if(it == "null") "0" else it } + weightUnits
            detailedFatsValue.text = arguments?.getString("fat")?.toString()?.let { if(it == "null") "0" else it } + weightUnits
            detailedNutritionCaloriesValue.text = arguments?.getString("calorie")?.toString()?.let { if(it == "null") "0" else it } + calorieUnits
            detailedNutritionProteinValue.text = arguments?.getString("protein")?.toString()?.let { if(it == "null") "0" else it } + weightUnits
            detailedNutritionFatsValue.text = arguments?.getString("fat")?.toString()?.let { if(it == "null") "0" else it } + weightUnits
            detailedNutritionCarbsValue.text = arguments?.getString("carbs")?.toString()?.let { if(it == "null") "0" else it } + weightUnits
            detailedNutritionSValue.text = arguments?.getString("satfat")?.toString()?.let { if(it == "null") "0" else it } + weightUnits
            detailedNutritionPolyValue.text = arguments?.getString("polyfat")?.toString()?.let { if(it == "null") "0" else it } + weightUnits
            detailedNutritionMonoValue.text = arguments?.getString("monofat")?.toString()?.let { if(it == "null") "0" else it } + weightUnits
            detailedNutritionSugarValue.text = arguments?.getString("sugar")?.toString()?.let { if(it == "null") "0" else it } + weightUnits
            detailedNutritionFiberValue.text = arguments?.getString("fiber")?.toString()?.let { if(it == "null") "0" else it } + weightUnits
            amountEt.setText("")
        }
